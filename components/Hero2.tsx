    ...
    <div className="relative 2xl:top-[80px]  overflow-y-hidden md:top-[56px] top-[45px] h-[97vh] w-screen md:h-[94vh] min350:h-[96vh] items-center justify-center flex ">
      <div className="w-screen xl:px-[220px] px-[10px] lg:px-[150px] min920:px-[100px]  md:px-[50px] min632:px-[50px] ">
        <div className="md:px-8 px-4 min-[2560px]:px-40 min-[2200px]:px-40 min-[3072px]:px-[250px]   relative  ">
          ...
          >
            <div className=" relative w-[15rem] h-[15rem] min-[3216px]:h-[45rem] min-[3216px]:w-[45rem]  min-[2400px]:h-[35rem] min-[2400px]:w-[35rem]  lg:w-[20rem] lg:h-[20rem] 2xl:h-[25rem] 2xl:w-[25rem]    rounded-full overflow-hidden shadow-white shadow-blue-100 dark:shadow-5xl shadow-lg animate-spin-2 ">
              <Image
          ...
          <BackgroundCircles />
          <Tilt tiltReverse>
            <motion.div className=" min-[3216px]:h-[1480px] min-[2880px]:h-[1200px] min-[1900px]:h-[800px]  min-[2400px]:h-[900px] h-[450px]  min-[2560px]:h-[1000px]     bg-white   bg-opacity-10 rounded-2xl shadow-5xl border border-r-0 border-b-0 border-opacity-30 backdrop-filter backdrop-blur-sm z-30  lg:h-[480px]  md:h-[400px]   min1440:h-[600px]  min-[500px]:h-80  2xl:h-[700px] ">
              <div className="flex min-[3216px]:h-[1480px] min-[2880px]:h-[1200px] min-[1900px]:h-[800px]  min-[2400px]:h-[900px] flex-col h-[450px]  min-[2560px]:h-[1000px]  min-[500px]:h-80 2xl:h-[700px]  items-center justify-evenly lg:h-[500px] md:h-[370px] min1440:h-[600px] ">
                <img
                  className="border z-10 h-[250px] min-[3216px]:h-[800px] min-[3216px]:w-[1200px]  min-[500px]:h-44 min-[2880px]:w-[800px] min-[2880px]:h-[600px] min-[2560px]:h-[500px] min-[2560px]:w-[700px]  min-[500px]:w-56  w-42 object-cover  overflow-hidden rounded-md border-r-0 border-b-0 lg:h-64 lg:w-96 md:h-[200px] md:w-[350px] 2xl:h-[300px] 2xl:w-[500px] opacity-90"
                  src="/coding.gif"
